...
export default function RegistrierenPage() {
  ...
  const handleShopperSignup = async () => {
    ...
    if (data.user && !data.session) {
      ...
      router.push('/shopper-portal/dokumente')
    }
  }
        ...
        <div className="bg-white rounded-3xl p-10 max-w-md w-full text-center shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            ...
            {role === 'customer'
              ...
              : ' Bestätigen Sie Ihre E-Mail, um mit der Shopper-Registrierung fortzufahren.'}
          </p>
          ...
          {!role ? (
            <>
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  <ArrowRight size={18} className="text-gray-300 group-hover:text-red group-hover:translate-x-1 transition-all" />
                </button>
                ...
                >
                  ...
                  <ArrowRight size={18} className="text-gray-300 group-hover:text-orange-dark group-hover:translate-x-1 transition-all" />
                </button>
              </div>
            </>
          ) : role === 'customer' ? (
            <>
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <h1 className="text-xl font-black text-gray-900">Als Käufer registrieren</h1>
              </div>
            ...
            <>
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <h1 className="text-xl font-black text-gray-900">Als Shopper registrieren</h1>
              </div>
              <p className="text-sm text-gray-500 mb-5">
                Nach der Registrierung benötigen wir noch einige Dokumente (Führungszeugnis, ggf. Aufenthaltstitel).
              </p>
              ...
              <div className="bg-orange/10 rounded-xl p-3.5 mb-5 flex gap-2.5">
                ...
                <p className="text-xs text-orange-dark leading-relaxed">
                  Nach der Bestätigung führen wir Sie durch die Dokumenten-Verifizierung (Führungszeugnis, Aufenthaltstitel bei Bedarf, Fahrzeugart).
                </p>
              </div>
